...
CREATE TABLE `previews_hdr` (
  ...
  `txt_ident` varchar(100) COLLATE utf8mb4_0900_as_cs DEFAULT NULL,
  `txt_mo` varchar(3) COLLATE utf8mb4_0900_as_cs DEFAULT NULL,
  ...
  `txt_name` varchar(25) COLLATE utf8mb4_0900_as_cs DEFAULT NULL,
  `fn_ident` varchar(50) COLLATE utf8mb4_0900_as_cs DEFAULT NULL,
  `fn_mo` varchar(3) COLLATE utf8mb4_0900_as_cs DEFAULT NULL,
  `fn_yr` int(11) DEFAULT NULL,
  `fn_volume` int(11) DEFAULT NULL,
  `fn_vol_issue` int(11) DEFAULT NULL,
  `fn_issue` int(11) DEFAULT NULL,
  ...
  `fn_path` varchar(500) COLLATE utf8mb4_0900_as_cs NOT NULL,
  PRIMARY KEY (`pvh_id`),
